...
exports.deleteUnitService = exports.updateUnitService = exports.getUnitService = exports.getUnitsService = exports.createUnitService = void 0;
...
const createUnitService = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (unit) {
        throw new apiError_1.ApiError(http_status_1.default.NOT_FOUND, 'Unit is already exist');
    }
...
// get units service
const getUnitsService = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page, skip } = (0, paginationHelper_1.calculatePagination)(options);
    const { searchTerm } = filters, filterData = __rest(filters, ["searchTerm"]);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
            OR: unit_constants_1.unitSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                },
            })),
    ...
    const total = yield prisma_1.default.unit.count({
        where: whereConditions,
    });
    return {
        meta: {
...
// get unit service
const getUnitService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.unit.findUnique({
        where: {
            id,
        },
    });
...
exports.getUnitService = getUnitService;
// update unit service
const updateUnitService = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield prisma_1.default.unit.findUnique({
        where: {
            id,
        },
    });
    ...
    if (!isExist) {
        throw new apiError_1.ApiError(http_status_1.default.BAD_REQUEST, 'Unit not found');
    }
...
const deleteUnitService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (((_a = isExist === null || isExist === void 0 ? void 0 : isExist.products) === null || _a === void 0 ? void 0 : _a.length) > 0) {
        throw new apiError_1.ApiError(http_status_1.default.BAD_REQUEST, 'Unit has link with products');
    }
